...
def main():
    ...
    (public / "capture_script.py").write_bytes(Path(__file__).read_bytes())
    ...
    summary = {"schema": "rfmapping.rx-characterization/v1", "run_id": run_id, "started_utc": utc(),
               ...
               "cases": []}
    cases = []
    rates = [2500000] if args.suite == "smoke" else ([5000000, 6000000, 7000000] if args.suite == "threshold" else [2500000, 5000000, 10000000, 20000000, 30720000, 61440000])
    for fs in rates:
    ...
    if args.suite == "threshold":
        cases.append({"id":"repeat_5msps", "sample_rate_hz":5000000, "bandwidth_hz":4000000, "gain_db":40, "lo_hz":args.lo, "blocks":256})
