...
def main():
    ...
    try:
        ...
        if excess>8 or guard['fifo_overflow_observed'] or guard['iq_metrics']['rail_component_count']:
        ...
        while gains:
            ...
            try:
                ...
                if txbuf.write(tx.tobytes())!=tx.nbytes: raise RuntimeError('Short TX buffer write')
                txbuf.push()
