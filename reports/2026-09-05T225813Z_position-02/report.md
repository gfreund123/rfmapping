# position-02: RF collection review

Run `2026-09-05T225813Z_position-02`. Operator placed setup at spot 2. Reported SDR rotation approximately 140-220 degrees relative to spot 1; axis and direction unspecified. Position, height and antenna geometry unmeasured. Combined position-and-orientation comparison.

Operator reports setup now at spot 2. Instructed to keep equipment fixed during full collection; exact operator posture and movement require separate annotation.

![Position measurements](overview.png)

Acquisition ready to move: **True**. Mapping ready: **False**.

Paired frequency centers: 97 / 97. RF bursts: 219. Total commanded TX-unmute interval: 83.909 seconds.
...
Absolute ascending/descending transfer-power difference: median 0.3232 dB; 95th percentile 0.9026 dB.

For the averaged signal/noise statistic, the corresponding differences are 0.1193 dB and 0.3258 dB. This divides by within-burst estimated averaging noise; it can reduce common gain variation but is not an independent calibration. Channel motion can also enter the variance estimate. Both original power and this diagnostic are retained.

| Control | Measured change | Expected |
|---|---:|---:|
| start, 5771.5 MHz | -2.790 dB | -3 dB |
| start, 5853.1 MHz | -3.268 dB | -3 dB |
| end, 5771.5 MHz | -2.534 dB | -3 dB |
| end, 5853.1 MHz | -3.224 dB | -3 dB |
