# position-01: RF collection review

Run `2026-09-05T221649Z_position-01`. First multi-position capture at the original desk location.

Operator instructed to remain still; exact pose and movement times not independently measured.

![Position measurements](overview.png)

Acquisition ready to move: **True**. Mapping ready: **False**.

Paired frequency centers: 97 / 97. RF bursts: 219. Total commanded TX-unmute interval: 84.189 seconds.
...
Absolute ascending/descending transfer-power difference: median 0.3044 dB; 95th percentile 0.6702 dB.

For the averaged signal/noise statistic, the corresponding differences are 0.0849 dB and 0.1999 dB. This divides by within-burst estimated averaging noise; it can reduce common gain variation but is not an independent calibration. Channel motion can also enter the variance estimate. Both original power and this diagnostic are retained.

| Control | Measured change | Expected |
|---|---:|---:|
| start, 5771.5 MHz | -2.770 dB | -3 dB |
| start, 5853.1 MHz | -3.204 dB | -3 dB |
| end, 5771.5 MHz | -3.388 dB | -3 dB |
| end, 5853.1 MHz | -3.356 dB | -3 dB |
