...
def main():
    ...
    result={'schema':'rfmapping.deep-reconstruction-validation/v1','created_utc':utc(),'hardware_access':False,
        'reference_results_sha256_lf_utf8':hashlib.sha256(args.reference_results.read_text().encode()).hexdigest(),
        'baseband_model_sha256_lf_utf8':hashlib.sha256(args.model.read_text().encode()).hexdigest(),
